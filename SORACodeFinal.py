...
def AirRisk(aoi,flights,start_date_time_obj,end_date_time_obj,min_altitude,max_altitude, path):
    ...
    which is a file containing the area of the area of interest in km^2. 
    ...
    #converting m2 dataframe to km2
    km2 = m2/10**6
...
def GroundRisk(aoi,pop,flights,start_date_time_obj,end_date_time_obj,min_altitude,max_altitude,path): 
    """
...
def main ():
    ...
    print("No formating erros with the input.")
    GroundRisk(aoi,pop,flights,start_date_time_obj,end_date_time_obj,min_altitude,max_altitude,path)
